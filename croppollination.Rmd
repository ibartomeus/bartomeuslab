...
We already compiled data on more than 100 study systems worldwide, comprising > 600 fields from 20 different crop species. We will update the map soon.
...
- *Do you want pan trap data?* We updated the landscape to capture the sampling method. While pollinator abundance or visitation rates are more direct methods. Pan trap data or unestrcutured sweep netting data are also interesting.
