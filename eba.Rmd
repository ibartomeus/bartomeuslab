...
En nuestra comunidad de agricultores ya participan: Royal, Primor, SAT San Sebastián y Alcafruit. 
...
m <- map_leaflet(x = crop_map, color = c("red", "blue", "green", "orange", "orange", "orange", "orange")) %>% addTiles(urlTemplate = "http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png")
m
